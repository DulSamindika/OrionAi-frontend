  ...
  const handleSelect = (model) => {
    ...
    <Container className="mt-5">
      ...
      <Row style={{margin:"50px"}}>
        <Col md={2}>
        <Button variant="outline-light" style={{margin:"20px", justifyContent:"flex-start"}}onClick={() => window.location.href='/TaskA32'}>Back</Button>
        </Col>
        <Col md={8}>
        <h5>Level 3</h5>
        ...
        <Col md={2}>
        <Button variant="light" style={{margin:"20px"}} onClick={() => window.location.href='/TaskA34'}>Next Task</Button>
        </Col>
      </Row>
    </Container>
    </div>
